...
ALTER TABLE public.activity ADD CONSTRAINT fk_activity_category_id FOREIGN KEY (category_id)
...
ALTER TABLE public.activity ADD CONSTRAINT fk_activity_account_id FOREIGN KEY (account_id)
